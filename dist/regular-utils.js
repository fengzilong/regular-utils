...
function startOfYear$1 (dirtyDate) {
  var cleanDate = parse$3(dirtyDate);
  var date = new Date(cleanDate.getFullYear(), 0, 1, 0, 0, 0, 0);
  return date
}

var index$8 = startOfYear$1;
...
var index$12 = startOfDay$1;

var startOfDay = index$12;
...
var index$10 = differenceInCalendarDays$1;

var parse$1 = index$4;
var startOfYear = index$8;
var differenceInCalendarDays = index$10;
...
var index$18 = startOfWeek$1;

var startOfWeek = index$18;
...
var index$16 = startOfISOWeek$1;

var parse$7 = index$4;
var startOfISOWeek$3 = index$16;
...
function getISOYear$2 (dirtyDate) {
  ...
  var startOfNextYear = startOfISOWeek$3(new Date(year + 1, 0, 4));
  var startOfThisYear = startOfISOWeek$3(new Date(year, 0, 4));
...
var index$22 = getISOYear$2;

var getISOYear$1 = index$22;
var startOfISOWeek$2 = index$16;
...
function startOfISOYear$1 (dirtyDate) {
  ...
  var date = startOfISOWeek$2(new Date(year, 0, 4));
  return date
}

var index$20 = startOfISOYear$1;

var parse$5 = index$4;
var startOfISOWeek = index$16;
var startOfISOYear = index$20;
...
var index$26 = buildDistanceInWordsLocale$1;
...
var index$30 = buildFormattingTokensRegExp$1;

var buildFormattingTokensRegExp = index$30;
...
var index$28 = buildFormatLocale$1;

var buildDistanceInWordsLocale = index$26;
var buildFormatLocale = index$28;
...
var getDayOfYear = index$2;
var getISOWeek = index$14;
var getISOYear = index$22;
var parse = index$4;
var enLocale = index$24;
...
var timeformat = function ( value, format ) {
	return index$1( new Date( Number( value ) ), format );
};

var countdown = function ( element, expr ) {
	var tickId;
	...
	this.$watch( expr, function ( endTime ) {
		...
		function tick() {
			...
			var timeobj = duration( nowTime, endTime );
...
function duration( startTime, endTime ) {
	...
	var hour = Math.floor( ( delta % DAY ) / HOUR );
	var minute = Math.floor( ( delta % HOUR ) / MINUTE );
	var second = Math.floor( ( delta % MINUTE ) / SECOND );
	var millisecond = Math.floor( ( delta % SECOND ) / MILLISECOND );
